...
function palindrome(str) {
  //убираем верхний регистр методом toLowerCase
  str = str.toLowerCase();
  //разбираем объект методом split на массив, разворачиваем в обратном порядке методом reverse, собираем в новый объект методом join, сравниваем новый объект с первоначальным
